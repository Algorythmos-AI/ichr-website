...
//  - The five named casualties are published as written, confirmed with the client. They
//    already appear on the public card.
//  - One corruption in the source .rtf was corrected with the client's approval:
